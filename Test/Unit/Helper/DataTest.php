...
namespace SendPulse\Mageia\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected $_helper;
    /**
     * @var \SendPulse\Mageia\Model\Logger\SendPulse|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $_logger;
    ...
    protected function setUp(){
        ...
        $storeManagerMock = $this->getMockBuilder('Magento\Store\Model\StoreManagerInterface')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_logger = $this->getMockBuilder('SendPulse\Mageia\Model\Logger\Magemonkey')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_helper = $objectManager->getObject('SendPulse\Mageia\Helper\Data',
            [
                'context'=>$contextMock,
